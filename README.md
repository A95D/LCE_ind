...
![ETL BPMN Diagram](sources/BPMN_сегментация_клиентов.png)
...
## Проверка гипотез
На этапе сегментации были сформулированы 2 гипотезы. Ниже проведена попытка их проверки с использованием построенной витрины.
